...
const PokeCard: React.FC<PokeCardProps> = ({ image, code, name, types }) => {
  return (
    <div className="w-fit bg-white flex flex-col gap-2 px-10 py-8 shadow-md hover:shadow-xl relative hover:-translate-y-1 transition-all duration-200 rounded-md">
